...
@Component({
  selector: 'app-professor-consulta-detalhada',
  templateUrl: './professor-consulta-detalhada.component.html',
  styleUrls: ['./professor-consulta-detalhada.component.css']
})
export class ProfessorConsultaDetalhadaComponent implements OnInit {
