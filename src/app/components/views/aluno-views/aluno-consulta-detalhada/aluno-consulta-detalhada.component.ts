...
@Component({
  selector: 'app-aluno-consulta-detalhada',
  templateUrl: './aluno-consulta-detalhada.component.html',
  styleUrls: ['./aluno-consulta-detalhada.component.css']
})
export class AlunoConsultaDetalhadaComponent implements OnInit {
